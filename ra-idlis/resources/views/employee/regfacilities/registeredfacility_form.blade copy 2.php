            ...
            <div class="col-lg-12 text-justify">
                ...
                <div class="container">
                    <form id="regform">
                        <div class="row">
                            <div class="col-md">
                                <label for="facility_name">Registered Facility ID <span class="text-danger">*</span></label>
                                <input type="text" name="regfac_id" class="form-control" placeholder="Registered Facility ID" id="regfac_id" required readonly="readonly">
                                <small id="facility_name_feedback" class="feedback"></small>
                            </div>
                            <div class="col-md">
                                <label for="facility_name">NHFR Code<span class="text-danger">*</span></label>
                                <input type="text" name="nhfr_code" class="form-control" placeholder="NHFR Code" id="nhfr_code" required readonly="readonly">
                            </div>
                            <div class="col-md">
                                <label for="facility_name">Facility Type <span class="text-danger">*</span></label>
                                <input type="text" name="facilitytype" class="form-control" placeholder="NHFR Code" id="facilitytype" required readonly="readonly">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="facilityname" class="form-control" placeholder="FACILITY NAME" id="facility_name" required readonly="readonly">
                                <small id="facility_name_feedback" class="feedback"></small>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md">
                                ...
                                <input type="text"  id="region" name="rgnid"  class="form-control" value="" readonly="readonly">
                            </div>
                            <div class="col-md">
                                <label for="province">Province/District <span class="text-danger">*</span></label>
                                <input type="text"  id="provid" name="provid"  class="form-control" value="" readonly="readonly">
                            </div>
                            <div class="col-md">
                                <label for="city_monicipality">City/Municipality <span class="text-danger">*</span></label>
                                <input type="text"  id="city_monicipality" name="cmid"  class="form-control" value="" readonly="readonly">
                            </div>
                            <div class="col-md">
                                <label for="brgy">Baranggay<span class="text-danger">*</span></label>
                                <input type="text"  id="brgy" name="brgyid"  class="form-control" value="" readonly="readonly">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md">
                                ...
                                <input type="text" class="form-control" id="street_num" name="street_number" value='{{((isset($fAddress) && count($fAddress) > 0) ? $fAddress[0]->street_number: null)}}' readonly="readonly">
                            </div>
                            <div class="col-md">
                                <label for="street_name">Street name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="street_name" name="street_name" value='{{(( isset($fAddress) && count($fAddress) > 0) ? $fAddress[0]->street_name: null)}}' readonly="readonly">
                            </div>
                            <div class="col-md">
                                <label for="zip">Zip Code <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="zip" name="zipcode" value='{{((isset($fAddress) && count($fAddress) > 0) ? $fAddress[0]->zipcode: null)}}' readonly="readonly">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="fac_mobile_number" name="contact" placeholder="FACILITY MOBILE #" value='{{((isset($fAddress) && count($fAddress) > 0) ? $fAddress[0]->contact: null)}}' readonly="readonly">
                            </div>
                            <div class="col-md-6">
                                <label for="fac_email_address">Facility Email Address <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="fac_email_address" name="email" placeholder="EMAIL" value='{{(isset($fAddress) && (count($fAddress) > 0) ? $fAddress[0]->email: null)}}' readonly="readonly">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-sm"> <input type="number" placeholder="Area code" name="areacode" id="areacode" class="form-control" readonly="readonly" /></div>
                                    <div class="col-sm"> <input type="number" name="landline" id="landline" placeholder="FACILITY LANDLINE" class="form-control" value='{{(isset($fAddress) && (count($fAddress) > 0) ? $fAddress[0]->landline: null)}}' readonly="readonly" /></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-sm"> <input type="number" placeholder="Area code" name="faxareacode" id="faxareacode" class="form-control" readonly="readonly" /></div>
                                    <div class="col-sm"> <input type="number" name="faxNumber" id="faxNumber" placeholder="FACILITY FAX #" class="form-control" value='{{(isset($fAddress) && (count($fAddress) > 0) ? $fAddress[0]->faxNumber: null)}}' readonly="readonly" /></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm">
                                ...
                                <input type="text" class="form-control" id="owner" name="owner" placeholder="OWNER (Name/Company/Organization)" readonly="readonly" />
                            </div>
                            <div class="col-sm">
                                <label for="prop_email">Proponent/Owner Email Address <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="prop_email" name="ownerEmail" placeholder="Proponent/Owner Email Address"  readonly="readonly" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm"> <input type="text" class="form-control" id="prop_mobile" name="ownerMobile" placeholder="Mobile No." readonly="readonly" /></div>
                            <div class="col-sm"> <input type="text" class="form-control" id="prop_landline_areacode" name="ownerLandlienAreacode" placeholder="Area Code" readonly="readonly" /></div>
                            <div class="col-sm"> <input type="text" class="form-control" id="prop_landline" name="ownerLandline" placeholder=" Landline" readonly="readonly" /></div>
                        </div>
                        ...
                        {{-- <center>
                            <button id="mainbtn" style="width: 20%;" class="btn btn-primary p-2 m-1" onClick="submtForm('update')">Submit</button>
                        </center>  --}}
