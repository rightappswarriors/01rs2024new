...
@if (session()->exists('employee_login'))   
  ...
  @section('content')
  {{-- <input type="text" id="CurrentPage" hidden="" value="RIR002">  --}}
      ...
      <table class="table table-hover" style="font-size:13px;" id="1example">
            <thead>
              <tr>
                  ...
                  <td scope="col" style="text-align: center;">Institutional Character</td>
                  ...
                  <td scope="col" style="text-align: center;">Date Complied</td>
                  <td scope="col" style="text-align: center;">Date Forwarded to Process Owner</td>
                  <td scope="col" style="text-align: center;">Date Release to Records</td>
