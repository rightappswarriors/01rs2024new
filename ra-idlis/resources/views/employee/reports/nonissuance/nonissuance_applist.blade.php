...
@if (session()->exists('employee_login'))   
  ...
  @section('content')
  {{-- <input type="text" id="CurrentPage" hidden="" value="RNIR001">  --}}
  <div class="content p-4">
  	<div class="card" style="width: 165vh;" >
  		<div class="card-header bg-white font-weight-bold">
        <h3> {{$pg_title}} </h3>
      </div>
        @include('employee.reports.nonissuance.rptNonIssuanceFilter') 
      ...
      <table class="table table-hover" style="font-size:13px;" id="1example">
            <thead>
              <tr>
                  ...
                  <td scope="col" style="text-align:center">Authorization Applied</td>   
