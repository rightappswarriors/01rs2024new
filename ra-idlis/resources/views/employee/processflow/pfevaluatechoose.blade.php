		...
		<script>
			$(function(){
				...
				if($('.main div').length == $('.main p.done').length){
					$('.buttonHere').empty().append('<a href="{{asset('employee/dashboard/processflow/assessment/compiled/'.$appId.'/'.$apptype.'/')}}" class="button6 btn-block">Display Summary of Reports</a>');
				}
