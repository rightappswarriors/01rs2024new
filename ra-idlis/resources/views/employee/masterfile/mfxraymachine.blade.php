@if (session()->exists('employee_login'))    
  ...
  @section('title', 'FDA X-Ray Machine')
  @section('content')
  ...
  <div class="content p-4">
      ...
      <div class="card">
          <div class="card-header bg-white font-weight-bold">
             X-Ray Machine <span class="#"><a href="#" title="Add New X-Ray Machine" data-toggle="modal" data-target="#myModal">
                      ...
                      <td>
                        <center>
                          <span class="FD007_update">
                            <button type="button" class="btn btn-outline-warning" onclick="showData('{{$xray->xrayid}}', '{{$xray->xraydesc}}');" data-toggle="modal" data-target="#GodModal"><i class="fa fa-fw fa-edit"></i></button>
                          </span>
                          <span class="FD007_cancel">
                            <button type="button" class="btn btn-outline-danger" onclick="showDelete('{{$xray->xrayid}}');" data-toggle="modal" data-target="#DelGodModal"><i class="fa fa-fw fa-trash"></i></button>
                          </span>
                        </center>
                      </td>
                    </tr>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content" style="border-radius: 0px;border: none;">
          <div class="modal-body" style=" background-color: #272b30;color: white;">
            <h5 class="modal-title text-center"><strong>Edit X-Ray Machine</strong></h5>
            <hr>
            <div class="container">
  ...
  <div class="modal fade" id="DelGodModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content" style="border-radius: 0px;border: none;">
          <div class="modal-body" style=" background-color: #272b30;color: white;">
            <h5 class="modal-title text-center"><strong>Delete X-Ray Machine</strong></h5>
            <hr>
            <div class="container">
              ...
              if (form.parsley().isValid()) {
                  ...
                  $.ajax({
                    ...
                    success: function(data) {
                      if (data == 'DONE') {
                          alert('Successfully Added New X-Ray Machine');
                          location.reload();
                      } else if (data == 'ERROR'){
              ...
              form.parsley().validate();
               if (form.parsley().isValid()) {
                 ...
                 $.ajax({
                    ...
                    success: function(data){
                        if (data == "DONE") {
                            alert('Successfully Edited X-Ray Machine');
                            location.reload();
                        } else if (data == 'ERROR') {
