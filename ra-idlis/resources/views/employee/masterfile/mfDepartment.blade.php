@if (session()->exists('employee_login'))    
  ...
  @section('title', 'Department Master File')
  @section('content')
  <input type="text" id="CurrentPage" hidden="" value="PR001">
  <div class="content p-4">
      ...
      <div class="card">
          <div class="card-header bg-white font-weight-bold">
             Department <span class="PR001_add"><a href="#" title="Add New Department" data-toggle="modal" data-target="#myModal"><button class="btn-primarys"><i class="fa fa-plus-circle"></i>&nbsp;Add new</button></a></span>
                ...
                <tbody>
                  @if (isset($depts))
                    ...
                    <tr>
                      ...
                      <td>
                        <center>
                          <span class="PR001_update">
                            <button type="button" class="btn btn-outline-warning" onclick="showData('{{$dept->depid}}', '{{$dept->depname}}');" data-toggle="modal" data-target="#GodModal"><i class="fa fa-fw fa-edit"></i></button>
                          </span>
                          <span class="PR001_cancel">
                            <button type="button" class="btn btn-outline-danger" onclick="showDelete('{{$dept->depid}}', '{{$dept->depname}}');" data-toggle="modal" data-target="#DelGodModal"><i class="fa fa-fw fa-trash"></i></button>
                          </span>
                        </center>
                      </td>
                    </tr>
  ...
  <script type="text/javascript">
      ...
      function deleteNow(){
            ...
            $.ajax({
              url : "{{ asset('employee/mf/del_department') }}",
              method: 'POST',
            ...
            event.preventDefault();
              ...
              form.parsley().validate();
               if (form.parsley().isValid()) {
                 ...
                 var y = $('#edit_desc').val();
                 $.ajax({
                    url: "{{ asset('employee/mf/save_department') }}",
                    method: 'POST',
