@if (session()->exists('employee_login'))    
  ...
  @section('title', 'License Type Master File')
  @section('content')
  <input type="text" id="CurrentPage" hidden="" value="PR005">
  <div class="content p-4">
      ...
      <div class="card">
          <div class="card-header bg-white font-weight-bold">
             License Type&nbsp;<span class="MA09_add"><a href="#" title="Add New Application Type" data-toggle="modal" data-target="#myModal"><button class="btn-primarys"><i class="fa fa-plus-circle"></i>&nbsp;Add new</button></a></span>
                  ...
                  @if (isset($plitype))
  	                @foreach ($plitype as $plitypes)
  	                  <tr>
  	                    ...
  	                    <td>
  	                      <center>
  	                        <span class="PR005_update">
  	                          <button type="button" class="btn btn-outline-warning" onclick="showData('{{$plitypes->plid}}', '{{$plitypes->pldesc}}');" data-toggle="modal" data-target="#GodModal"><i class="fa fa-fw fa-edit"></i></button>
  	                        </span>
  	                        <span class="PR005_cancel">
  	                          <button type="button" class="btn btn-outline-danger" onclick="showDelete('{{$plitypes->plid}}', '{{$plitypes->pldesc}}');" data-toggle="modal" data-target="#DelGodModal"><i class="fa fa-fw fa-trash"></i></button>
  	                        </span>
  	                      </center>
  	                    </td>
  	                  </tr>
  ...
  <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog" role="document">
          ...
          color: white;">
              <h5 class="modal-title text-center"><strong>Add New License Type</strong></h5>
              <hr>
              <div class="container">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content" style="border-radius: 0px;border: none;">
          <div class="modal-body" style=" background-color: #272b30;color: white;">
            <h5 class="modal-title text-center"><strong>Edit License Type</strong></h5>
            <hr>
            <div class="container">
  ...
  <script type="text/javascript">
      ...
      function deleteNow(){
            ...
            $.ajax({
              url : "{{ asset('employee/mf/del_licensetype') }}",
              method: 'POST',
              data: {_token:$('#token').val(),id:id,mod_id : $('#CurrentPage').val()},
              success: function(data){
               if (data == 'DONE') {
                   alert('Successfully deleted '+name);
                  window.location.href = "{{ asset('/employee/dashboard/mf/licensetype') }}";
               } else if (data == 'ERROR') {
          ...
          if (form.parsley().isValid()) {
              ...
              if (test == -1) { // Not in Array
                  $.ajax({
                    ...
                    success: function(data) {
                      if (data == 'DONE') {
                          alert('Successfully Added New License Type');
                          window.location.href = "{{ asset('/employee/dashboard/mf/licensetype') }}";
                      } else if(data == 'ERROR'){
                ...
                alert('License Type is already been taken');
                $('#new_rgnid').focus();
              }
          }
      });
            ...
            event.preventDefault();
              ...
              form.parsley().validate();
               if (form.parsley().isValid()) {
                 ...
                 var y = $('#edit_desc').val();
                 $.ajax({
                    url: "{{ asset('employee/mf/save_licensetype') }}",
                    method: 'POST',
                    data : {_token:$('#token').val(),id:x,name:y,mod_id : $('#CurrentPage').val()},
                    success: function(data){
                        if (data == "DONE") {
                            alert('Successfully Edited License Type');
                            window.location.href = "{{ asset('/employee/dashboard/mf/licensetype') }}";
                        } else if (data == 'ERROR') {
