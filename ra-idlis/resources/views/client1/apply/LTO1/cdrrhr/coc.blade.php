@if (session()->exists('uData'))  
	...
	<body>
		...
		<div class="container text-center font-weight-bold mt-5">Radiology COC</div>
		<div style="padding: 2%;" >
	        ...
	        <div class="modal-dialog" role="document">
	            <div class="modal-content">
	                <div class="modal-header" id="viewHead">
	                    <h5 class="modal-title" id="viewModalLabel">Add COC</h5>
	                ...
	                <div class="modal-body" id="viewBody">
	                   	<form id="personnelAdd">
                            ...
                            <input type="hidden" name="fda_type" value="Radiology">
                            <div class="container">
		...
		<script>
            onStep(3);
            slider([],['fda','CDRRHR/personnel',{{$appid}}]);
        </script>
		<script>
				...
				$("#personnelEdit").empty().append(
					'<div class="container pl-5">'+
                            '{{csrf_field()}}'+
                                ...
                                '<input type="hidden" class="form-control w-100" name="fda_type" value="Radiology">'+
                        '<div class="row mb-2">'+
                            '<div class="col-sm">'+
                                'COC Number:'+
                            '</div>'+
                        ...
                        '</div>'+
                            '<div class="row mb-2">'+
                            '<div class="col-sm">'+
                                'COC Validity<span class="text-danger">*</span>'+
                            '</div>'+
                            '<div class="col-sm-11">'+
                                '<input value="'+coc_validity+'" class="form-control w-100" name="valid_to" required="">'+
                            '</div>'+
                        '</div>'+
                        '<div class="row mb-2">'+
                            '<div class="col-sm">'+
