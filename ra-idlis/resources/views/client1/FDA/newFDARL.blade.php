        ...
        <div  style="padding-left: 8%;padding-right: 8%;">
			<div class="card-body">
				...
				<div class="container mt-4">
					<span style="font-weight: 50em;" class="tab">This is to recommend approval of request [notification]/application for amendment
/issuance/ of License to Operate/ Certification of:</span>
					</div>
				...
				<div class="container mt-4 font-weight-bold">
                   ...
                   <div class="row pt-1">
                    ...
                    <div class="row pt-1">
						<div class="col-md-5">Chief Pharmacist</div>
						<div class="col-md-1">:</div>
						<div class="col-md-6"></div>
					</div>
                    <div class="row pt-1">
               ...
               <span class="tab"> The establishment has satisfactorily </span> with the documentary requirements
                pursuant to <b>Administrative Order 2020-0017</b> entitled <b>Revised Guidelines on the Unified
                Licensing Requirements and Procedures of the Food and Drug Administration
                Repealing Administrative Order No. 2016-0003 </b>particularly for the operation of an
                establishment as <b>Hospital Pharmacy</b> and shall serve as basis for the <b> <u>ISSUANCE</u></b> of License
                to Operate under the One-Stop Shop.
				</div>
