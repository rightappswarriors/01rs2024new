...
<div  class="row">
        ...
        <section class="container-fluid">
            ...
            <div class="card">
                ...
                <select class="form-control" id="aptidnew" name="aptidnew" disabled="">
                    ...
                    <option value="IC" selected="selected">Initial Change</option>
                </select>
            </div>
    ...
    <label for="typeOfApplication">Type of Application <span class="text-danger">*</span></label>
        ...
        <input class="form-control" id="typeApp" type="text" value="{{$registered_facility->hfser_desc}}" readonly="">
        </div>
    </div>
    ...
    <div class="form-group col-md-6">
        ...
        <input class="form-control" id="license_number" type="text" readonly=""  value="{{$registered_facility->con_id}} {{$registered_facility->ptc_id}} {{$registered_facility->lto_id}} {{$registered_facility->ato_id}} {{$registered_facility->coa_id}} {{$registered_facility->cor_id}}">
    </div>

    <div class="form-group col-md-6">
        <label for="approving_authority_pos">Validity</label>
        <input class="form-control" id="validity" type="text" readonly="" value="{{$validity}}">
    </div>

    <div class="form-group col-md-12">
        <label for="facility_name">Facility Name<span class="text-danger">*</span></label>
        <div class="input-group">
        <input type="text" name="facilityname" readonly class="form-control" placeholder="FACILITY NAME" value="{{$registered_facility->facilityname}}" id="facility_name" onblur="checkFacilityNameNew(this.value)" required=""> 

        </div>
    </div>
    <div class="form-group col-md-12">
    <label for="facility_name">Facility Address<span class="text-danger">*</span></label>
        <div class="input-group">
        <input type="text" name="facilityaddress" readonly="" class="form-control" placeholder="FACILITY ADDRESS" value="{{$registered_facility->mailingAddress}}" id="facility_address" onblur="checkFacilityNameNew(this.value)" required=""> 
