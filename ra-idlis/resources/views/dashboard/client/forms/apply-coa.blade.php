        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- <input type="hidden" name="uid" id="uid" value="$user->uid"/> 6-9-2021 -->
                    ...
                    @if(isset($appid) && app('request')->input('grp') == 'c' && app('request')->input('grpn') == 'c'):
                    <div class="form-group row col-md-12 mt-5">
                        <div class="col-lg-4 col-md-4 col-xs-12"></div>
                        <div class="col-lg-4 col-md-4  text-center bg-primary">

                            <a class="btn text-white" style="border-radius: 3px;" href="{{asset('client1/apply/attachment')}}/{{$hfser}}/{{$appid}}">
