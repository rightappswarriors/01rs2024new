...
<div class="col-md-3 change-div">
    ...
    <input type="number" class="form-control"  id="fac_mobile_number"  name="contact"  placeholder="FACILITY MOBILE #"
...
<div class="col-md-3 change-div">
    ...
    <div class='form-group row'>
        <div class="col-xs-12 col-md-6 col-lg-5">
            <input  type="number" placeholder="Area code" name="areacode"  id="areacode"  required  class="form-control"   />
        </div>
        <div class="col-xs-12 col-md-6 col-lg-7">
            <input  type="number"  name="landline"  id="landline" placeholder="FACILITY LANDLINE" required class="form-control" 
...
<div class="col-md-3 change-div">
    ...
    <div class="form-group row">
        <div class="col-xs-12 col-md-6 col-lg-5">
            <input   type="number"   placeholder="Area code"  name="faxareacode"   id="faxareacode" required  class="form-control" />
        </div>
        <div class="col-xs-12 col-md-6 col-lg-7">
            <input type="number"  name="faxNumber"   id="faxNumber" placeholder="FACILITY FAX #"  required
                class="form-control"   value='{{(isset($fAddress) && (count($fAddress) > 0) ? $fAddress[0]->faxNumber: null)}}'  />
        </div>
    </div>
</div>
<div class="col-md-3 change-div">
