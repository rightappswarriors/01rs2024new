  ...
  <div class="content p-4">
      <div class="card">
          <div class="card-header bg-white font-weight-bold">
            <h3>Approval/Issuance Certificate  ({{$request =='machines' ? 'Radiation Facility' : 'Pharmacy'}}) </h3> 
          </div>
                              ...
                              @endphp
                                ...
                                <tr>
                                  ...
                                  <!-- <td class="text-center" style="font-weight:bold;">{{(AjaxController::getTransStatusById($data->FDAstatus)[0]->trns_desc ?? '')}}</td> -->
                                    <td><center>
                                        <button type="button" title="Evaluate Payment for {{$data->facilityname}}" class="btn btn-outline-primary" onclick="window.location.href='{{asset('employee/dashboard/processflow/FDA/approval')}}/{{$data->appid}}/{{$request}}'" ><i class="fa fa-fw fa-check" ></i></button>
                                    </center></td>
                                </tr>
