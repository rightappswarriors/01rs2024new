@if (session()->exists('employee_login'))   
  ...
  @section('title', 'Province Master File')
  @section('content')
  <input type="text" id="CurrentPage" hidden="" value="PL002">
  ...
  <div class="content p-4">
      <div class="card">
          <div class="card-header bg-white font-weight-bold">
             Provinces <span class="PL002_add"><a href="#" title="Add New Province" data-toggle="modal" data-target="#myModal"><button class="btn-primarys"><i class="fa fa-plus-circle"></i>&nbsp;Add new</button></a></span>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content" style="border-radius: 0px;border: none;">
              <div class="modal-body" style=" background-color: #272b30;color: white;">
                <h5 class="modal-title text-center"><strong>Delete Province</strong></h5>
                <hr>
                <div class="container">
  ...
  <script type="text/javascript">
          ...
          table.clear().draw();
            for (var i = 0; i < x.length; i++) {
              ...
              var e = $('#'+x[i]+'_pro').attr('value');
               $('#example').DataTable()
                 .row
                 .add([d, '<center><span class="PL002_update"><button type="button" class="btn btn-outline-warning" onclick="showData(\''+e+'\',\''+d+'\');" data-toggle="modal" data-target="#GodModal"><i class="fa fa-fw fa-edit"></i></button></span>&nbsp<span class="PL002_cancel"><button type="button" class="btn btn-outline-danger" onclick="showDelete(\''+e+'\', \''+d+'\');" data-toggle="modal" data-target="#DelGodModal"><i class="fa fa-fw fa-trash"></i></button></span></center>'
                  ])
                 .draw();
            } 
            GroupRightsActivate();
      ...
      function deleteNow(){
        ...
        $.ajax({
          url : "{{ asset('employee/mf/del_province') }}",
          method: 'POST',
            ...
            event.preventDefault();
              ...
              form.parsley().validate();
               if (form.parsley().isValid()) {
                 ...
                 var y = $('#edit_desc').val();
                 $.ajax({
                    url: "{{ asset('employee/mf/save_province') }}",
                    method: 'POST',
