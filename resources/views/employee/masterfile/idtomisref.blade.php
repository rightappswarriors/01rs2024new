  ...
  <div class="content p-4">
      ...
      <div class="card">
          <div class="card-header bg-white font-weight-bold">
             Ref Facility <span class="TM001_add" ><a href="#" title="Import" data-toggle="modal" data-target="#myModal"><button class="btn btn-primarys"><i class="fa fa-plus-circle" style="cursor: pointer;"></i>Import</button></a></span>
          </div>
          <div class="card-body">
              <table class="table display" id="example" style="overflow-x: scroll;" >
  				<thead>
  					<tr>
  					  <th style="width: 10%">Facility No</th>
              ...
              <th style="width: 10%">Owner Name</th>
  				...
  				<tbody>
  					@if (isset($ref_facility))
  						@foreach ($ref_facility as $ref)
  						<tr>
  							<td scope="row"> {{$ref->facilityNo}}</td>
  							<td>{{$ref->accreNo}}</td>
  							<td>{{$ref->adr}}</td>
                <td>{{$ref->emailAdr}}</td>
    	...
    	<div class="modal-dialog" role="document">
          <div class="modal-content" style="border-radius: 0px;border: none;">
            	<div class="modal-body text-justify" style=" background-color: #272b30;color: white;">
                  <h5 class="modal-title text-center"><strong>Import Ref Facility</strong></h5>
                  <hr>
                  <div class="container">
                    <form method="POST" action="{{asset('employee/idtomis/import/ref')}}" enctype="multipart/form-data">
                      {{ csrf_field() }}
