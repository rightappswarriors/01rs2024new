      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <select class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" name="fo_aptid" id="fo_aptid">
              <option value="" @if (!isset($fo_aptid))  selected @endif  >All Records</option>
              <option value="AF" @if (isset($fo_aptid)) @if ($fo_aptid ==  'AF' )  selected @endif @endif >Application Form</option>
              <option value="E" @if (isset($fo_aptid))  @if ($fo_aptid == 'E' )  selected  @endif @endif >Evaluation (for CON/PTC)</option>
              <option value="I" @if (isset($fo_aptid))  @if ($fo_aptid == 'I' )  selected  @endif @endif >AT    (LTO)</option>
              <option value="M" @if (isset($fo_aptid))  @if ($fo_aptid == 'M' )  selected  @endif @endif >Monitoring</option>
              <option value="LS" @if (isset($fo_aptid))  @if ($fo_aptid == 'LS' )  selected  @endif @endif >Letter Suspension</option>
              <option value="LFD" @if (isset($fo_aptid))  @if ($fo_aptid == 'LFD' )  selected  @endif @endif >Letter for Denial</option>
              <option value="C" @if (isset($fo_aptid))  @if ($fo_aptid == 'C' )  selected  @endif @endif >Complaints</option>
            </select>
          </div>
        ...
        <div class="col-md-3">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" name="fo_email" id="fo_email"  value="@if(isset($fo_email)){{$fo_email}}@endif">
