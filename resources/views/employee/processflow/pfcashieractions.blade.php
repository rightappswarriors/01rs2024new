        ...
        <div class="container-fluid border mb-3">
          ...
          <div class="modal-dialog modal-lg" role="document">
            ...
            @endif
                ...
                <hr>
                <div class="container">
                  <form method="POST" action="{{asset('employee/dashboard/cashierremarks')}}" enctype="multipart/form-data">
                      {{csrf_field()}}
                      <input type="hidden" name="appid" value="{{$APPID}}">
                      <input type="hidden" name="appform_idSubmit" value="@isset($AppData){{$AppData->appid}}@endisset">
          ...
          <tbody>
            ...
            @if(count($discounts) > 0)
              ...
              $discountedtotal = floatval($Amount) - floatval($discountprice);
						...
						@endphp
						<tr class="text-center">
              <td class="text-center font-weight-bold">{{$discounts[$i]->description}} {{$discounts[$i]->percentage}}%</td>
              <td class="text-center font-weight-bold">{{$AppData->hfser_id}}</td>
							<td></td>
            ...
            @if($DiscountPrice !== '')
            <!-- <tr>
            <td class="text-center font-weight-bold">Discount</td>
            <td class="text-center font-weight-bold"></td>
            <td class="text-center font-weight-bold">{{($Discount)}}% - Discount</td>
            <td style="text-align:left">- PHP {{number_format($DiscountPrice)}}</td>
            </tr> -->
            @endif
          </tbody>
        </table>
...
<div class="modal fade" id="AddGodModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      ...
      <div class="modal fade" id="add-discount" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" style="border-radius: 0px;border: none;">
              <div class="modal-body" style=" background-color: #272b30;color: white;">
                ...
                <hr>
                <div class="container">
                  <form method="POST" action="{{asset('employee/dashboard/cashierdiscount')}}" enctype="multipart/form-data">
                      {{csrf_field()}}
                      <input type="hidden" name="appid" value="{{$APPID}}">
                      <input type="hidden" name="appform_idSubmit" value="@isset($AppData){{$AppData->appid}}@endisset">
                      <div class="container">
                        ...
                        <div class="row">
                          <div class="col-6 pt-2">Percentage:</div>
                          <div class="col-6">
                            <input type="number" value="{{$Discount}}" max="100" min="0" required="" name="discount" class="form-control">
                          </div>
                        </div>
                        ...
                        <div class="row mt-5 mb-5">
                          ...
                          <div class="col-6">
                            <button class="btn btn-danger btn-block" type="button" onclick="$('#add-discount').modal('hide')">Cancel</button>
                          </div>
                        </div>
                      </div>
                  </form>
