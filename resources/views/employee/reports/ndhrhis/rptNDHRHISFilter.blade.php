  ...
  <div class="box box-solid">
    ...
    <div class="box-body border-radius-none">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <label class="control-label">NHFR Code</label>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="form-group">
              <label>Registered Facility ID</label>
              <input type="number" class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" name="fo_regfac_id" id="fo_regfac_id" value="@if(isset($fo_regfac_id)){{$fo_regfac_id}}@endif">          
          </div>
        </div>  
...
</svg> Export Data without NHFR Code
              </button>
            </div>
          </div>
          @endif
