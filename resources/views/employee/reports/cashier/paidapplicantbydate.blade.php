      ...
      <table class="table table-hover" style="font-size:13px;" id="1example">
            <thead>
              <tr>
                  ...
                  <td scope="col" style="text-align:center">Ownership/Class</td>
                  <td scope="col" style="text-align: center;">Payment Date</td>
                  <td scope="col" style="text-align: center;">Cashier</td>
                  <td scope="col" style="text-align:center">HFEP Funded</td>
                  <td scope="col" style="text-align: center;">Total Payments</td>
                  <td scope="col" style="text-align: center;">Payment Status</td>                 
              ...
              @if (isset($LotsOfDatas))
                @foreach ($LotsOfDatas as $data)
                    ...
                    <tr>
                      ...
                      <td style="text-align:left">{{$data->CashierApproveformattedDate}}</td>
                      <td style="text-align:left">{{$data->CashierApproveBy}}</td>
                      <td style="text-align:left">{{$data->ishfep}} {{$data->hfep_funded}}</td>
                      <td style="text-align:left">{{$data->totalpayment}}</td>
                      <td style="text-align:left">{{$data->paymentstatus}}</td>
                    </tr>
