        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-md-6"><input type="date" class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" name="fo_date_2" id="fo_date_2" ></div>
            </div>
          </div>         
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          <div class="form-group">
            ...
            <select class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" name="fo_assignedRgn" id="fo_assignedRgn" @if (isset($d_assignedRgn))   @php $fo_assignedRgn = $d_assignedRgn; @endphp  disabled="disabled"   @endif>
