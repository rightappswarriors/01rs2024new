...
@if (session()->exists('employee_login'))   
  ...
  <div class="content p-4" style="font-size:13px; margin-left:0px;" >
      ...
      <form class="filter-options-form">
        @include('employee.regfacilities.mclientuser') 
      </form>
                    ...
                    <tr>
                      <td class="text-center">
                          ...
                          <div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            <a href="#" >
                              <button type="button" data-toggle="modal" data-target="#ViewModal" onclick="showData('{{$data->uid}}','{{$data->fname}}','{{$data->mname}}','{{$data->lname}}','{{$data->contact}}',' ', '{{$data->email}}', '{{$data->grp_desc}}', '{{$data->position}}', '{{$data->teamdesc}}', '{{$data->facidesc}}',  '{{($data->isTempBanned ?? null)}}')" class="btn btn-outline-primary" title="View Account">&nbsp;<i class="fa fa-eye"></i>&nbsp;</button>
                            </a>

                            @if ($data->isActive == 1)
                              <span class="MG002_update">
                                <a href="#"><button data-toggle="modal" onclick="showIfActive({{$data->isActive}},'{{$data->uid}}','{{$data->fname}}','{{$data->mname}}','{{$data->lname}}')" data-target="#IfActiveModal" class="btn btn-outline-danger" title="Deactivate Account">&nbsp;<i class="fa fa-toggle-off"></i>&nbsp;</button></a>
                              </span>
                            @else
                              <span class="MG002_update">
                                <a href="#"><button type="button" data-toggle="modal" onclick="showIfActive({{$data->isActive}},'{{$data->uid}}','{{$data->fname}}','{{$data->mname}}','{{$data->lname}}')" data-target="#IfActiveModal" class="btn btn-outline-success" title="Reactivate Account">&nbsp;<i class="fa fa-toggle-on"></i>&nbsp;</button></a>
                              </span>
                            @endif
