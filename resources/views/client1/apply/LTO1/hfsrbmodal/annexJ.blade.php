<div class="remthis modal fade" id="viewModalJ" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel" aria-hidden="true" id="toDark">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 1350px !important;">
        <div class="modal-content">

            <div class="modal-header" id="viewHeadJ">
                <h5 class="modal-title">LIST OF PARAMETERS FOR EACH SERVICE CAPABILITY (Annex J)</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>

            <div class="modal-body" id="viewBodyJ">
                <div id="_errMsg"></div>

                <div class="card-body table-responsive" id="viewAllI">
                    <span id="viewModalHeader">
                        <button class="btn btn-primary mb-5" type="button" style="width:100px" data-toggle="modal" data-target="#addModalJ" id="addBtn">
                            Add
                        </button>
                    </span>
                    <div id="tApp_wrapper" class="dataTables_wrapper no-footer">
                        <table class="table table-hover" style="font-size: 13px;" id="tAppJ">
...
<div class="remthis modal fade mt-5" id="addModalJ" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel" aria-hidden="true" id="toDark" style="border-color: rgba(126, 239, 104, 0.8);">
...
<script type="text/javascript">
    ...
    $('#addModalJ').on('shown.bs.modal', function (e) {
        $("#viewBodyJ").css({ opacity: 0.5 });
        $("#viewBodyJ").css('background-color', '#dedede');
        $("#viewHeadJ").css({ opacity: 0.5 });
        $("#viewHeadJ").css('background-color', '#dedede');
        $("#addBtn").addClass("disabled");
        $('#form').parsley();
    })

    //when add modal closes
    $('#addModalJ').on('hidden.bs.modal', function (e) {
        $("#viewBodyJ").css({ opacity: 1 });
        $("#viewBodyJ").css('background-color', '#ffffff');
        $("#viewHeadJ").css({ opacity: 1 });
        $("#viewHeadJ").css('background-color', '#ffffff');
