		      			...
		      			@foreach($hfsrbannexi as $Equipment)
							<tr>
								...
								@if($canAdd)
									<td>
										<center>
											<button class="btn btn-warning"  data-toggle="modal" data-target="#editEquipment" onclick="showData('{{$Equipment->id}}','{{$Equipment->test}}','{{$Equipment->kittype}}','{{$Equipment->kit}}','{{$Equipment->lotno}}')"><i class="fa fa-edit"></i></button>&nbsp;
	                   	...
	                   	<form id="EquipmentAdd">
							...
							<div class="container pl-5">
								<div class="row mb-2">
		                   			...
		                   			<div class="col-sm-11">
		                   				<input class="form-control w-100" name="test" required="">
		                   			</div>
		                   		</div>
		                   		<div class="row mb-2">
		                   			<div class="col-sm">
		                   			...
		                   			<div class="col-sm-11">
		                   				<input class="form-control w-100" name="kittype" required="">
		                   			</div>
		                   		</div>
		                   		<div class="row mb-2">
		                   			<div class="col-sm">
		                   			...
		                   			<div class="col-sm-11">
		                   				<input class="form-control w-100" name="kit" required="">
		                   			</div>
		                   		</div>
		                   		<div class="row mb-2">
		                   			<div class="col-sm">
		                   			...
		                   			<div class="col-sm-11">
		                   				<input type="number" class="form-control w-100" name="lotno" required="">
		                   			</div>
		                   		</div>
					...
					'<div class="container pl-5">'+
		            	'<div class="row mb-2">'+
		            		...
		            		'<input type="hidden" name="id" value="'+id+'">'+
		                   			...
		                   			'</div>'+
		                   			'<div class="col-sm-11">'+
		                   				'<input class="form-control w-100" value="'+sname+'" name="test" required="">'+
		                   			'</div>'+
		                   		'</div>'+
		                   		'<div class="row mb-2">'+
		                   			'<div class="col-sm">'+
		                   			...
		                   			'</div>'+
		                   			'<div class="col-sm-11">'+
		                   				'<input class="form-control w-100" value="'+fname+'" name="kittype" required="">'+
		                   			'</div>'+
		                   		'</div>'+
		                   		'<div class="row mb-2">'+
		                   			'<div class="col-sm">'+
		                   			...
		                   			'</div>'+
		                   			'<div class="col-sm-11">'+
		                   				'<input class="form-control w-100" value="'+mname+'" name="kit" required="">'+
		                   			'</div>'+
		                   		'</div>'+
		                   		'<div class="row mb-2">'+
		                   			'<div class="col-sm">'+
		                   			...
		                   			'</div>'+
		                   			'<div class="col-sm-11">'+
		                   				'<input type="number" class="form-control w-100" value="'+prof+'" name="lotno" required="">'+
		                   			'</div>'+
		                   		'</div>'+
