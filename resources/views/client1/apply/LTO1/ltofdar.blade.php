			...
			<div class="col-md-8">
				...
				<div class="row marginbottom-md">
					<div class="col-md-4" style="text-align: center;">
						...
						<button class="btn btn-info" style="white-space: normal; width: 100%; height: 100%;" onclick="window.location.href='{{asset('client1/apply/fda/CDRR/coc/'.$appid)}}'"><i class="fa fa-paperclip"></i> COC </button>
					</div>
					<div class="col-md-4" style="text-align: center;">
