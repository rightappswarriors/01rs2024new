		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<div class="col-md-5" style="float:left;display: inline;font-family: Century Gothic; font-size: 13pt">
						:&nbsp;&nbsp;&nbsp;21 October 2017 – 31December 2019
					</div>
					<div class="col-md-1" style="display: inline">
						&nbsp;</div>
				</div>	
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<br><br><br><br>
						<p class="text-uppercase"  style="font-family: Arial;font-size: 16pt;"><strong>MARLYN W. CONVOCAR, M.D.{{--((isset($sec_name)) ? $sec_name->sec_name : 'DIRECTOR')--}}</strong></p>
						<p class="text-small" style="font-family: Arial;font-size: 14pt;">
							<strong style="margin-left: 6em;">Director IV</strong></p>
					</div>
